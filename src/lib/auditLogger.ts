...
export type AuditTable = 'users' | 'cameras' | 'payments' | 'user_roles' | 'public_utility_contacts' | 'profiles' | 'groups' | 'group_members' | 'edge_functions'; // Added new tables and edge_functions
